    ...
    plugins: [
        ...
        new CopyPlugin({
            patterns: [
                ...
                {
                    from: path.resolve(__dirname, 'maket/public'),
                    to: path.resolve(__dirname, 'docs/public'),
                    noErrorOnMissing: true,
                },
                {
                    from: path.resolve(__dirname, 'maket/public/favicon.ico'),
                    to: path.resolve(__dirname, 'docs/favicon.ico'),
                    noErrorOnMissing: true,
                },
                {
                    from: path.resolve(__dirname, 'vercel.json'),
                    to: path.resolve(__dirname, 'docs/vercel.json'),
                    noErrorOnMissing: true,
                },
                {
                    from: path.resolve(__dirname, '.vercelignore'),
